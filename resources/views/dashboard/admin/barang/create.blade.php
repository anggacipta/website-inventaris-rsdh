                    ...
                    <div class="card-body">
                        ...
                        <form id="barangForm" action="{{ route('barang.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="tanggal_kalibrasi" class="form-label">Tanggal Kalibrasi Barang(bisa dikosongkan)</label>
                                        <input type="date" class="form-control" name="tanggal_kalibrasi" id="tanggal_kalibrasi">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
