                            ...
                            <div class="modal-body">
                                <form action="{{ route('distributor.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_distributor" class="form-control" id="nama" aria-describedby="emailHelp">
                                    </div>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($distributors as $dist)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('distributor.edit', $dist->id) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('distributor.destroy', $dist->id) }}" method="post" class="d-inline delete-form">
                                @csrf
                                @method('delete')
