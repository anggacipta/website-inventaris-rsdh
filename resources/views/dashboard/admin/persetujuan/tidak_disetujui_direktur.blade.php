...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Pertidaksetujuan Direktur</h5>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('store.tidak.setuju.direktur', $maintenance->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="catatan_staff" class="form-label">Mengapa tidak disetujui?</label>
                                <textarea class="form-control" id="catatan_staff" name="catatan_direktur" rows="3" required></textarea>
                            </div>
